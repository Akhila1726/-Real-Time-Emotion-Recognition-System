...
def run_media_upload():
    ...
    # Ask user to select an image or video file
    ...
    def detect_emotions(frame):
        try:
            ...
            # Use retinaface detector explicitly for better detection on tough images
            ...
            # DeepFace returns dict if one face, list if multiple
